# Bem-vindo ao projeto "Front_Info"

Este projeto foi inicializado com [Create React App](https://github.com/facebook/create-react-app).

O repositório correspondente para o backend pode ser encontrado [aqui](link-para-o-repositório-backend).
...
**Nota: esta é uma operação unidirecional. Depois que você `eject`, não pode voltar!**
...
Você não precisa usar `eject` nunca. O conjunto de recursos selecionado é adequado para implantações pequenas e médias, e você não deve se sentir obrigado a usar este recurso. No entanto, entendemos que esta ferramenta não seria útil se você não pudesse personalizá-la quando estiver pronto para isso.
...
Esta seção foi movida para: [https://facebook.github.io/create-react-app/docs/advanced-
